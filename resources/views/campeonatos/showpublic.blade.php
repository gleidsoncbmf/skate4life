                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr auto 1fr; grid-gap: 10px;" class="text-center">
                        ...
                        <div style="grid-column: 2;">
                            <ul>
                                <li><a href="{{ route('inscricoes.create', ['id' => $campeonato->id]) }}" class="btn btn-success">Inscreva-se</a></li>
                                <br>
                                <li><a href="http://localhost:8000/" class="btn btn-secondary">Voltar para Pagina Inicial</a></li>
                        </div>
                        <div>
